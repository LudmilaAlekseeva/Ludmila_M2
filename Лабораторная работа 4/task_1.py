...
class Right_Triangle(Triangle):
    ...
    def __init__(self, a: Union[int, float], b: Union[int, float], c=None):
        """
    ...
    def perimeter(self) -> Union[int, float]:
        ...
        Выполнена перегрузка метода, так как для прямоугольного треугольника достаточно знать длины катетов, чтобы рассчитать длину гипотенузы и вычислить периметр
        """
...
class Regular_Triangle(Triangle):
    ...
    def __init__(self, a: Union[int, float], b=None, c=None):
        """
    ...
    def area(self) -> Union[int, float]:
        ...
        Выполнена перегрузка метода, так как для равностороннего треугольника есть более простая формула для расчета площади
        """
